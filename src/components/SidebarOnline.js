  ...
  >
    ...
    >
      ...
      <Menu iconShape="circle">
                    ...
                    <Link to="Abac/dashboard" replace>
                <MenuItem
              ...
              <Link to="Abac/my-account" replace>
                <MenuItem
                  icon={<FaUser />}
                  className={`ps-menuitem ${isToggled? 'ps-menuitem--collapsed' : ''} ${isActive('/dashboard')? 'active' : ''}`}
              ...
              <Link to="Abac/my-students" replace>
                <MenuItem
  ...
  return (
    ...
    >
      ...
      <Menu iconShape="circle">
        ...
        <Link to="Abac/competition" replace>
                <MenuItem
                      icon={<FaTrophy />}
                      className={`ps-menuitem ${isToggled? 'ps-menuitem--collapsed' : ''} ${isActive('/dashboard')? 'active' : ''}`}
